...
% Titulos de secao sem numeracao excessiva
...
\title{
  \vspace{-1cm}
  \large \textbf{Universidade Cat\'olica de Santos} \\
  \large Curso de Ci\^encia da Computa\c{c}\~ao \\[1.5cm]
  \LARGE \textbf{Explora+} \\[0.5cm]
  \large Relat\'orio T\'ecnico --- MVP Entregue
}
\author{
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figuras/atividade-explorar.png}
